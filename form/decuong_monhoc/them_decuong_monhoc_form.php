...
require_once("$CFG->libdir/formslib.php");
    ...
    class thong_tin_chung_decuong_monhoc_form extends moodleform{
        ...
        public function definition()
        {
            ...
            $mform->addElement('hidden', 'ma_monhoc', '');
            ...
            $mform->disabledIf('ten_monhoc1_thongtin_chung', '');
            ...
            $mform->disabledIf('ten_monhoc2_thongtin_chung', '');
            ...
            $mform->disabledIf('maso_monhoc_thongtin_chung', '');

            $eGroup=array();
            $eGroup[] =& $mform->createElement('text', 'loai_hocphan', '', 'size=50');
            $mform->addGroup($eGroup, 'thong_tin_chung_group2', get_string('loai_hocphan', 'block_educationpgrs'), array(' '),  false);
            ...
            $mform->disabledIf('thuoc_khoi_kienthuc_thongtin_chung', '');
            ...
            $mform->disabledIf('so_tinchi_thongtin_chung', '');
            ...
            $mform->disabledIf('tiet_lythuyet_thongtin_chung', '');
            ...
            $mform->disabledIf('tiet_thuchanh_thongtin_chung', '');
            ...
            $mform->disabledIf('monhoc_tienquyet_thongtin_chung', '');
    ...
    class chuan_daura_decuong_monhoc_form extends moodleform{
        ...
        public function definition()
        {
            global $CFG;
             ...
             $mform->addGroup($eGroup, 'thong_tin_chung_group133', get_string('chuan_daura', 'block_educationpgrs'), array(' '),  false);
             ...
             $eGroup=array();
             $eGroup[] =& $mform->createElement('text', 'mucdo_itu_chuan_daura', get_string('mucdo_itu_chuan_daura', 'block_educationpgrs'));
    ...
    class update_muctieu_monhoc_decuong_monhoc_form extends moodleform{
        ...
        public function definition(){
            ...
            //Group muc tieu mon hoc
            $mform = $this->_form;
            $mform->addElement('header','update_muctieu_monhoc', get_string('update_muctieu_monhoc', 'block_educationpgrs'));
            // $mform->setExpanded('group_muctieu_monhoc8', false);
            ...
            $eGroup=array();
            // $mform->registerNoSubmitButton('btn_submit_muctieu_monhoc');
            $eGroup[] =& $mform->createElement('submit', 'btn_submit_muctieu_monhoc', 'Cập nhật mục tiêu');
            $mform->addGroup($eGroup, 'thong_tin_chung_group13', '', array(' '),  false);
        }
        function validation($data, $files)
        {
    ...
    class update_chuan_daura_decuong_monhoc_form extends moodleform{
        ...
        public function definition()
        {
            global $CFG;
             //Group chuan daura monhoc
             $mform = $this->_form;
             $mform->addElement('header','update_chuan_daura', get_string('update_chuan_daura', 'block_educationpgrs'));
            //  $mform->setExpanded('group_chuan_daura', false);
             ...
             $eGroup = $mform->addElement('submit', 'them_chuan_daura_monhoc_submit', 'Cập nhật chuẩn đầu ra');
        }
        function validation($data, $files)
        {
            return array();
    ...
    class update_giangday_TH_decuong_monhoc_form extends moodleform{
        ...
        public function definition()
        {
            ...
            //Group ke hoach giang day
            $mform = $this->_form;
            $mform->addElement('header','update_kehoach_giangday_th_monhoc', get_string('update_kehoach_giangday_th_monhoc', 'block_educationpgrs'));
            // $mform->setExpanded('group_giangday_TH', false);
            ...
            $eGroup = $mform->addElement('submit', 'them_kehoach_giangday_TH_submit', 'Cập nhật kế hoạch giảng dạy');
        }
        function validation($data, $files)
        {
            return array();
    ...
    class update_giangday_LT_decuong_monhoc_form extends moodleform{
        ...
        public function definition()
        {
            ...
            //Group ke hoach giang day
            $mform = $this->_form;
            $mform->addElement('header','update_kehoach_giangday_lt_monhoc', get_string('update_kehoach_giangday_lt_monhoc', 'block_educationpgrs'));
            // $mform->setExpanded('group_giangday_LT', false);
            ...
            $eGroup = $mform->addElement('submit', 'them_kehoach_giangday_LT_submit', 'Cập nhật kế hoạch giảng dạy lý thuyết');
        }
        function validation($data, $files)
        {
            return array();
    ...
    class update_danhgia_decuong_monhoc_form extends moodleform{
        ...
        public function definition()
        {
            global $CFG;
             //Group danh gia
             $mform = $this->_form;
             $mform->addElement('header','update_danhgia_monhoc', get_string('update_danhgia_monhoc', 'block_educationpgrs'));
            //  $mform->setExpanded('group_danhgia', false);
             ...
             $eGroup=array();
             $eGroup[] =& $mform->createElement('submit', 'them_danhgia_monhoc_submit', 'Cập nhật đánh giá môn học');
             $mform->addGroup($eGroup, 'thong_tin_chung_group28', '', array(' '),  false);
        }
        function validation($data, $files)
        {
    ...
    class update_tainguyen_monhoc_decuong_monhoc_form extends moodleform{
        ...
        public function definition()
        {
            ...
            //Group tai nguyen mon hoc
            $mform = $this->_form;
            $mform->addElement('header','update_tainguyen_monhoc', get_string('update_tainguyen_monhoc', 'block_educationpgrs'));
            // $mform->setExpanded('group_tainguyen', false);
            ...
            $eGroup = $mform->addElement('submit', 'them_tainguyen_monhoc_submit', 'Cập nhật tài nguyên môn học');
        }
        function validation($data, $files)
        {
            return array();
    ...
    class update_quydinh_chung_decuong_monhoc_form extends moodleform{
        ...
        public function definition()
        {
            global $CFG;
             // mo ta quy dinh chung
             $mform = $this->_form;
             $mform->addElement('header','update_quydinh_chung_monhoc', get_string('update_quydinh_chung_monhoc', 'block_educationpgrs'));
            //  $mform->setExpanded('group_mota_quydinh_chung', false);
             ...
             $eGroup = $mform->addElement('submit', 'them_quydinh_chung_submit', 'Cập nhật quy định chung');
        }
        function validation($data, $files)
        {
            return array();
