...
class add_ctdt_to_nganh_form extends moodleform {
    ...
    public function definition()
    {
        ...
        $mform->addElement('text', 'ma_ctdt', 'Tên đầy đủ', 'size="200"');
        $mform->addRule('ma_ctdt', get_string('error'), 'required', 'extraruledata', 'server', false, false);
        $mform->setType('ma_ctdt', PARAM_TEXT);
