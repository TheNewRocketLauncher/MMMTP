...
$PAGE->navbar->add($nganhdt->ten_nganh);
// Title.
$PAGE->set_title('Quản lý Ngành ' . $nganhdt->ten_nganh);
$PAGE->set_heading('Quản lý Ngành ' . $nganhdt->ten_nganh);
echo $OUTPUT->header();

// $table = get_table_nganhdt_byID($id);
