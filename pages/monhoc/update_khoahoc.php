...
// Setting up the page.
$PAGE->set_url(new moodle_url('/blocks/educationpgrs/pages/monhoc/update_khoahoc.php', ['courseid' => $courseid, 'id' => $id]));
...
echo $OUTPUT->header();
 ...
 // Form
 require_once('../../form/decuong_monhoc/mo_khoahoc_form.php');
