...
require_once('../../form/decuong_monhoc/muctieu_monhoc_form.php');
...
echo \html_writer::tag(
    'button',
    'Xóa Muc Tieu',
    array('id' => 'btn_delete_muctieumonhocanbc'));
...
if ($mform1->is_cancelled()) {
    ...
    $toform->ten_monhoc1_thongtin_chung = $chitietmh->ten_monhoc_a;
    // $toform->ten_monhoc2_thongtin_chung = $chitietmh->ten_monhoc_b;
    ...
    // $toform->monhoc_tienquyet_thongtin_chung = $chitietmh->danhsach_mon_tq;
...
if ($mform2->is_cancelled()) {
    ...
    // $muctieu_muctieu_monhoc = $mform2->get_data()->muctieu_muctieu_monhoc; //select
    // $mota_muctieu_muctieu_monhoc = $mform2->get_data()->mota_muctieu_muctieu_monhoc; 
    // $chuan_daura_cdio_muctieu_monhoc = $mform2->get_data()->chuan_daura_cdio_muctieu_monhoc; //select

    
    $param2 = new stdClass();
    $param2->ma_monhoc = $a;
    $param2->muctieu = $mform2->get_data()->muctieu_muctieu_monhoc;
    $param2->mota = $mform2->get_data()->mota_muctieu_muctieu_monhoc;
    $param2->danhsach_chuan_daura = $mform2->get_submit_value('chuan_daura_cdio_muctieu_monhoc');
...
if ($mform3->is_cancelled()) {
    ...
    $param2 = new stdClass();
    $param2->ma_monhoc = $a;
    $param2->ma_cdr = $mform3->get_data()->chuan_daura;
    $param2->mota = $mform3->get_data()->mota_chuan_daura;
    $param2->mucdo_utilize = $mform3->get_data()->Mucdo_ITU_chuan_daura;
    ...
    // $chuan_daura = $mform->get_data()->chuan_daura; //select
    // $mota_chuan_daura = $mform->get_data()->mota_chuan_daura; //textarea
    // $Mucdo_ITU_chuan_daura = $mform->get_data()->Mucdo_ITU_chuan_daura; //select


    // $tuan_giangday = $mform->get_data()->tuan_giangday; //select
    // $ngay_giangday = $mform->get_data()->ngay_giangday;
    // $chude_giangday = $mform->get_data()->chude_giangday; //textarea
    // $baitap_giangday = $mform->get_data()->baitap_giangday;


    // $ma_danhgia = $mform->get_data()->ma_danhgia; //select
    // $ten_danhgia = $mform->get_data()->ten_danhgia;
    // $mota_danhgia = $mform->get_data()->mota_danhgia;//textarea
    // $cac_chuan_daura_danhgia = $mform->get_data()->cac_chuan_daura_danhgia;
    // $tile_danhgia = $mform->get_data()->tile_danhgia; 

    // $loai_tainguyen = $mform->get_data()->loai_tainguyen; //select
    // $mota_tainguyen = $mform->get_data()->mota_tainguyen;//textarea
    // $link_tainguyen = $mform->get_data()->link_tainguyen; 

    // $mota_quydinh_chung = $mform->get_data()->mota_quydinh_chung;//textarea
...
if ($mform4->is_cancelled()) {
    ...
    $param2 = new stdClass();
    $param2->ma_monhoc = $a;
    $param2->ten_chude = $mform4->get_data()->chude_giangday;
    $param2->danhsach_cdr = $mform4->get_data()->danhsach_cdr;
    $param2->hoatdong_gopy = $mform4->get_data()->hoatdong_giangday;
    $param2->hoatdong_danhgia = $mform4->get_data()->hoatdong_danhgia;
...
if ($mform5->is_cancelled()) {
    ...
    $param2 = new stdClass();
    $param2->ma_monhoc = $a;
    $param2->ma_danhgia = $mform5->get_data()->ma_danhgia;
    $param2->ten_danhgia = $mform5->get_data()->ten_danhgia;
    $param2->mota_danhgia = $mform5->get_data()->mota_danhgia;
    $param2->chuan_daura_danhgia = $mform5->get_data()->cac_chuan_daura_danhgia;
    $param2->tile_danhgia = $mform5->get_data()->tile_danhgia;
...
if ($mform6->is_cancelled()) {
    ...
    $param2 = new stdClass();
    $param2->ma_monhoc = $a;
    $param2->loai_tainguyen = $mform6->get_data()->loai_tainguyen;
    $param2->mota_tainguyen = $mform6->get_data()->mota_tainguyen;
    $param2->link_tainguyen = $mform6->get_data()->link_tainguyen;
...
if ($mform7->is_cancelled()) {
    ...
    $param2 = new stdClass();
    $param2->ma_monhoc = $a;
    $param2->mota_quydinh_chung = $mform7->get_data()->mota_quydinh_chung;
