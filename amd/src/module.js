    ...
    return {
        init: function() {
            ...
            $("#btn_delete_chuandauramonhoc").click(function() {
                // alert(12345);
                var list_id = [];
                var cusid_ele = document.getElementsByClassName('chuandaura_monhoc_checkbox');
                for (var i = 0; i < cusid_ele.length; ++i) {
                    var item = cusid_ele[i];  
            ...
            $("#btn_delete_khgdltmonhoc").click(function() {
                // alert(12345);
                var list_id = [];
                var cusid_ele = document.getElementsByClassName('kehoach_giangday_LT_checkbox');
                for (var i = 0; i < cusid_ele.length; ++i) {
                    var item = cusid_ele[i];  
            ...
            $("#btn_delete_danhgiamonhoc").click(function() {
                // alert(12345);
                var list_id = [];
                var cusid_ele = document.getElementsByClassName('danhgia_monhoc_checkbox');
                for (var i = 0; i < cusid_ele.length; ++i) {
                    var item = cusid_ele[i];  
            ...
            $("#btn_delete_tainguyenmonhoc").click(function() {
                // alert(12345);
                var list_id = [];
                var cusid_ele = document.getElementsByClassName('tainguyen_monhoc_checkbox');
                for (var i = 0; i < cusid_ele.length; ++i) {
                    var item = cusid_ele[i];  
            ...
            $("#btn_delete_quydinhchungmonhoc").click(function() {
                // alert(12345);
                var list_id = [];
                var cusid_ele = document.getElementsByClassName('quydinh_chung_monhoc_checkbox');
                for (var i = 0; i < cusid_ele.length; ++i) {
                    var item = cusid_ele[i];  
            ...
            $("#btn_delete_nganhdt").click(function () {
                //alert('123');
                var list_id = [];
                var cusid_ele = document.getElementsByClassName('nganhdtcheckbox');
                for (var i = 0; i < cusid_ele.length; ++i) {
                    var item = cusid_ele[i];
                ...
                list_id.forEach(element => {
                    $.post(M.cfg.wwwroot + '/blocks/educationpgrs/ajax/delete_nganhdt.php', {
                        course: 1,
                        id: element
                    }).done(function (data) {
                        alert(data);
            ...
            $("#btn_delete_chuyennganhdt").click(function () {
                //alert('123');
                var list_id = [];
                var cusid_ele = document.getElementsByClassName('chuyennganhdtcheckbox');
                for (var i = 0; i < cusid_ele.length; ++i) {
                    var item = cusid_ele[i];
                ...
                list_id.forEach(element => {
                    $.post(M.cfg.wwwroot + '/blocks/educationpgrs/ajax/delete_chuyennganhdt.php', {
                        course: 1,
                        id: element
                    }).done(function (data) {
                        alert(data);
